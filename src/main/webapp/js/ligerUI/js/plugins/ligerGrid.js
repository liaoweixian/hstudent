    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        */
        ...
        _addNewRecord: function (o, previd, pid)
        {
            ...
            if (o[p.statusName] != "add" && o[p.statusName] != "update")  //corrected wx 02/11 
        ...
        cleanEditHistory : function(){ //add wx 03 13
        	var g = this , data = g.data.Rows;
			for(var i = 0 ; i < data.length ; i++){
				data[i].__status = "nochanged";
			}
			g.data.Rows = data;
		
			$('.l-grid-row-cell-edited').removeClass('l-grid-row-cell-edited');
        },
