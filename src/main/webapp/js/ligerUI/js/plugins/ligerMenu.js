...
(function ($)
{
    ...
    $.ligerui.controls.Menu.ligerExtend($.ligerui.core.UIComponent, {
        ...
        getItem : function(itemId){ //add Method wx 03/16  得到一个菜单的项
        	var g = this, p = this.options , items = this.options.items;
        ...
        setItemText : function(itemId , text){//add Method wx 03/16  修改菜单的text
        	this.getItem(itemId).text = text;  //设置文本
        	this._render();		//重画
        }
    });
    //旧写法保留
